...
\begin{figure}[htpb]
    \centering
    \includegraphics[scale=.8]{fig/CAMCOS/Toy.pdf}
...
\begin{figure}[htpb]
    \centering
    \includegraphics[scale=.8]{fig/CAMCOS/Toy_MeanRegimeLifetimeComparison.pdf}
...
\begin{figure}[htpb]
    \centering
    \includegraphics[scale=.8]{fig/CAMCOS/Toy_AnaVSTraj.pdf}
...
\begin{figure}[htpb]
    \centering
    \includegraphics[scale=.8]{fig/CAMCOS/Toy3d_loglog.pdf}
...
\begin{figure}[htpb]
    \centering
    \includegraphics[scale=.8]{fig/CAMCOS/Toy3d_MeanRegimeLifetimeComparisoneps005.pdf}
...
\begin{figure}[htpb]
    \centering
    \includegraphics[scale=.8]{fig/CAMCOS/Sets_subsample_10_sigma_0.01.pdf}
...
\begin{figure}[htpb]
    \centering
    \includegraphics[scale=.8]{fig/CAMCOS/CdVloglog_10_0.01.pdf}
...
\begin{figure}[htpb]
    \centering
    \includegraphics[scale=.8]{fig/CAMCOS/TOLifetimes_increase_fine_10_0.01.pdf}
...
\begin{figure}[htpb]
    \centering
    \includegraphics[scale=.8]{fig/CAMCOS/CdV_point_vs_MeanEscape_10_0.01.pdf}
...
\begin{figure}[htpb]
    \centering
    \includegraphics[scale=.8]{fig/CAMCOS/CdV_lifetimes_fine_10_0.01.pdf}
...
\begin{figure}[htpb]
    \centering
    \includegraphics[scale=.8]{fig/CAMCOS/CdV_MeanRegimeLifetimeComparison_10_0.01.pdf}
...
\section{Remarks on the evaluation of \cref{eq:analytic_1d}}
    ...
    \begin{figure}[!htbp]
        ...
        \includegraphics[scale=1]{fig/CAMCOS/figComb/CombFig1.pdf}%
