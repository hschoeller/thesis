...
Here, persistence and transition probabilities rather than local anomalies or gradient reversals
...
been proposed that explain different aspects of the phenomenon, based on different assumptions and perspectives.

More traditional theories on blockings focus on barotropiclarge scale
