...
illustration, especially considering that the background flow is highly variable.
...
for a long time \parencite{kuoVorticityTransferRelated1951} and atmospheric blockings
...
or eddy-eddy \parencite{yamazakiVortexVortexInteractions2013, luoNonlinearMultiscaleInteraction2014}
interactions can lead to the kinds of persistent anomalies associated with blocking.
What barotropic theories often lack is a mechanism for the strength of the
...
enstrophy downscale \parencite{kittungDifferences2DQG2003} and the extent to 
which either of the processes dominate depends on the specific flow condition, scale
and stratification.
...
stratified turbulent flow. There is even evidence that such baroclinic energy
conversions take place within some blockings themselves, pointing out that the
assumption of equivalent-barotropic structure is not always justified
\parencite{martineauBaroclinicBlocking2022}.

Baroclinic theories emphasize the role of the vertical structure of the flow and
a variety of baroclinic models were proposed over
the years to investigate these processes \parencite[e.g.~][]{vautardSourceMidlatitudeLowfrequency1988, marshallDynamicalUnderstandingPlanetaryScale1993}. 
Many have frequently highlighted the importance of upstream disturbances (including cyclones) and wave-interactions
for blocking onset and decay. 
In a simple two-layer model, \textcite{luoPlanetaryscaleBaroclinicEnvelope2000}
