...
% was developed jointly by all authors. The computations, figures, and \cref{sec:EDA_}
% were the responsibility of the thesis author. RC developed the theory and
% wrote \cref{sec:EDA_}. RC and the thesis author jointly wrote the first draft and
